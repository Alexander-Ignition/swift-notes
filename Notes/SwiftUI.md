...
- [Key Path Member Lookup](https://github.com/apple/swift-evolution/blob/main/proposals/0252-keypath-dynamic-member-lookup.md)
- [Callable values of user-defined nominal types](https://github.com/apple/swift-evolution/blob/main/proposals/0253-callable.md)
- [Property Wrappers](https://github.com/apple/swift-evolution/blob/main/proposals/0258-property-wrappers.md)
- [Identifiable Protocol](https://github.com/apple/swift-evolution/blob/main/proposals/0261-identifiable.md)
- [Increase availability of implicit self in @escaping closures when reference cycles are unlikely to occur](https://github.com/apple/swift-evolution/blob/main/proposals/0269-implicit-self-explicit-capture.md)
- [Multiple Trailing Closures](https://github.com/apple/swift-evolution/blob/main/proposals/0279-multiple-trailing-closures.md)
- [@main: Type-Based Program Entry Points](https://github.com/apple/swift-evolution/blob/main/proposals/0281-main-attribute.md)
- [Forward-scan matching for trailing closures](https://github.com/apple/swift-evolution/blob/main/proposals/0286-forward-scan-trailing-closures.md)
...
- [Build complications in SwiftUI](https://developer.apple.com/wwdc20/10048)
- [App essentials in SwiftUI](https://developer.apple.com/wwdc20/10037)
- [Visually edit SwiftUI views](https://developer.apple.com/wwdc20/10185)
- [Stacks, Grids, and Outlines in SwiftUI](https://developer.apple.com/wwdc20/10031)
- [Build a SwiftUI view in Swift Playgrounds](https://developer.apple.com/wwdc20/10643)
- [Build document-based apps in SwiftUI](https://developer.apple.com/wwdc20/10039)
- [Data Essentials in SwiftUI](https://developer.apple.com/wwdc20/10040)
- [Build SwiftUI views for widgets](https://developer.apple.com/wwdc20/10033)
...
- [Structure your app for SwiftUI previews](https://developer.apple.com/wwdc20/10149)

## WWDC21

### [Simplify with SwiftUI](https://developer.apple.com/news/?id=vm5qjoj9)
...
- [Direct and reflect focus in SwiftUI](https://developer.apple.com/wwdc21/10023)
- [Bring Core Data concurrency to Swift and SwiftUI](https://developer.apple.com/wwdc21/10017)
- [SwiftUI Accessibility: Beyond the basics](https://developer.apple.com/wwdc21/10119)
- [Localize your SwiftUI app](https://developer.apple.com/wwdc21/10220)
- [Discover concurrency in SwiftUI](https://developer.apple.com/wwdc21/10019)

### [Code-Along: Build a great Mac app in SwiftUI](https://developer.apple.com/news/?id=6ja307qu)
